...
class CameraController extends Controller
{
    public function camaras($slug)
    {
        ...
        $kits                   = DB::table('kits') ->where('subclassification_id', $subclasi->id) ->where('status', 'published')->orderBy   ('orden', 'ASC') ->get();
        ...
        return view('menu.camaras.general', $data);
