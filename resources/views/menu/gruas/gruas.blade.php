@extends('master')
<!--Gruas -->
@section('title', 'grúas dollies y cabezas remotas')
@section('content')
    @foreach($subclasificaciones1 as $subclassication)

        @if ($subclassication->slug != "accesorios-gdc" )


            <div id="grua" class="container" style="padding: 0%; z-index: 98;">
                <div class="row justify-content-center align-items-center Height100 P-mtop" style="padding: 3% 0 0 0">
                    ...
                    @foreach ($subclasificaciones1 as $productos)
                        ...
                        <section id="{{  $productos->name }}" data-index="{{  $productos->name }}" class="{{  $productos->name }} camaras_body" style="margin-top: 1%; padding: 3% 5% 4% 5%; z-index: 98;">
                            ...
                            <div class="row justify-content-center align-items-center Height40">
                                ...
                                @foreach ($kits2 as $product)

                                    @if ($product->subclassification_id == $productos->id )
        ...
        @else
            ...
            <div id="accesorios-gdc" class="container" style="padding: 0%; z-index: 98;">
