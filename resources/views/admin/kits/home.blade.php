                    ...
                    <div class="panel shadow">
                        ...
                        <div class="inside">
                            ...
                            @if (kvfj(Auth::user()->permissions, 'kits_add'))
                                ...
                                {!! Form::open(['url' => '/admin/kit/add', 'files' => true]) !!}
                                ...
                                <tbody>
                                    @foreach ($cats as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="opts">
                                                    @if (kvfj(Auth::user()->permissions, 'kits_edit'))
                                                        <a href="{{ url('/admin/kit/'.$cat->id.'/edit') }}" data-toggle="tooltip" data-placement="top" title="Editar">
                                                            <i class="fas fa-edit" style="color: #ffc107;"></i>
                                                        </a>
                                                    @endif
                                                    @if (kvfj(Auth::user()->permissions, 'kits_delete'))
                                                        <a href="{{ url('/admin/kit/'.$cat->id.'/delete') }}" data-toggle="tooltip" data-placement="top" title="Eliminar">
