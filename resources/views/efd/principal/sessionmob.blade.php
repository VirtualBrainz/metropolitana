@if(Auth::check())
        ...
        <a id="use" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" onclick="toggleSidebar3()">
        ...
        <ul id="op-user" class=""  style="list-style: none; background-color: #fff; box-shadow: 0px 0px 1px 0px rgba(0, 0, 0, .15) !important; border-radius: 1px 1px 1px 1px !important;">
            @if ( Auth::user()->role == "1" )
